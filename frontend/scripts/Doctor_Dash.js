...
function displayData(data) {
    ...
    data.forEach(async (element) => {
        ...
        await fetch(`https://motionless-seal-windbreaker.cyclic.app/user/${element.user}`, {
            method: "GET",
            headers: {
                "Content-Type": "application/json",
                Authorization: `${token1}`,
        ...
        button.addEventListener("click", function () {
            ...
            fetch(`https://motionless-seal-windbreaker.cyclic.app/appointment/appoint/${AppointmentId}`, {
                method: "GET",
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `${token1}`,
...
formel.addEventListener("submit", (e) => {
    ...
    fetch(`https://motionless-seal-windbreaker.cyclic.app/appointment/doctorAppointment/${AppointmentId}`, {
        method: "PATCH",
        headers: {
            "Content-Type": "application/json",
            Authorization: `${token1}`,
